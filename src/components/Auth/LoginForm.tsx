        ...
        <div className="min-h-screen flex items-start justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 px-2 sm:px-4 lg:px-8 pt-16 pb-8">
            <div className="max-w-md w-full space-y-6 sm:space-y-8">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Hoş Geldiniz</h2>
                    <p className="text-sm sm:text-base text-gray-600">Görevlerinizi yönetmek için giriş yapın</p>
                </div>
